...
use halo2_proofs::{
    ...
    poly::{
        ...
        kzg::{
            ...
            multiopen::{ProverSHPLONK, VerifierSHPLONK, ProverGWC},
...
fn main() {
    ...
    println!("---------------------------");
    {
        ...
        bench_layer::<NETWORK0, 784>("FC_100_layers.json", 14).unwrap();
        ...
        // bench_layer::<NETWORK1, 784>("FC_150_layers.json", 15).unwrap();
        ...
        // bench_layer::<NETWORK2, 784>("FC_200_layers.json", 15).unwrap();
        ...
        // bench_layer::<NETWORK3, 784>("FC_350_layers.json", 16).unwrap();
        ...
        // bench_layer::<NETWORK4, 784>("FC_50_layers.json", 14).unwrap();
        ...
        // // bench_layer::<NETWORK5, 784>("FC_500_layers.json", 18).unwrap();
        ...
        // bench_layer::<NETWORK6, 784>("FC_75_layers.json", 14).unwrap();
    }
    ...
    //     bench_layer::<NETWORK0, 200>("FC_10_layers.json", 11).unwrap();
    ...
    //     bench_layer::<NETWORK1, 200>("FC_15_layers.json", 12).unwrap();
    ...
    //     bench_layer::<NETWORK2, 200>("FC_20_layers.json", 12).unwrap();
    //     const NETWORK3: NetworkArch = &[(32, 100, true), (100, 200, true), (200, 100, false), ];
    //     bench_layer::<NETWORK3, 200>("FC_3_layers.json", 11).unwrap();
    ...
    //     bench_layer::<NETWORK4, 200>("FC_30_layers.json", 13).unwrap();
    ...
    //     bench_layer::<NETWORK5, 200>("FC_40_layers.json", 13).unwrap();
    //     const NETWORK6: NetworkArch = &[(32, 100, true), (100, 200, true), (200, 100, true), (100, 200, true), (200, 100, false), ];
    //     bench_layer::<NETWORK6, 200>("FC_5_layers.json", 11).unwrap();
    // }
    // println!("num_params_small_benches");
    // println!("---------------------------");
    // //num params small benches 
    // {
    ...
    //     bench_layer::<NETWORK0, 177>("FC_177522_params.json", 11).unwrap();
    ...
    //     bench_layer::<NETWORK1, 88>("FC_48564_params.json", 11).unwrap();
    ...
    //     bench_layer::<NETWORK2, 122>("FC_87771_params.json", 11).unwrap();
    // }
}
